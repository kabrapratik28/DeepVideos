...
class conv_lstm_deconv_model():
    def __init__(self):
        ...
        self.outputs_exp = tf.placeholder(tf.float32, [self.batch_size, self.timesteps] + self.shape + [self.channels], name="conv_lstm_deconv_outputs_exp")  # (batch_size, timestep, H, W, C)
